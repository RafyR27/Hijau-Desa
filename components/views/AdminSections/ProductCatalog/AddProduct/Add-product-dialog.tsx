...
const AddProductDialog = ({ open, onOpenChange }: AddProductDialogProps) => {
  ...
  }, [isSuccessAddProduct, onOpenChange]);
      ...
      <DialogContent className="max-w-sm md:max-w-lg">
        <form onSubmit={handleSubmit(handleAddProduct)}>
          <DialogHeader>
            ...
            <DialogDescription>
              Isi informasi produk yang dapat ditukarkan warga di Warung Mitra.
            </DialogDescription>
          </DialogHeader>
          ...
          <FieldGroup className="py-4 no-scrollbar max-h-[70vh] overflow-y-auto px-1">
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <Label htmlFor="namaProduct">Nama Produk</Label>
                  <Input
                    {...field}
                    id="namaProduct"
                    type="text"
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <Label htmlFor="hargaPoin">Harga Poin Tukar</Label>
                  <Input
                    {...field}
                    id="hargaPoin"
                    type="number"
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <Label htmlFor="isActive-product">Status Produk</Label>
                  <Select
                    value={field.value ? "true" : "false"}
                    onValueChange={(val) => field.onChange(val === "true")}
                  >
                    <SelectTrigger id="isActive-product" className="w-full">
          ...
          <DialogFooter>
            ...
            >
              {isPendingAddProduct ? <Spinner /> : "Tambah Produk"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
